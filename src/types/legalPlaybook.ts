// =============================================================================
// PR-4.5A — Tipos do Playbook Jurídico (frontend).
// Espelha supabase/functions/_shared/playbooks/types.ts.
// =============================================================================
...
export const PLAYBOOK_STATUS_LABEL: Record<PlaybookComplianceStatus, string> = {
  aprovado_para_revisao: "Aprovado para revisão humana",
  revisar_antes: "Revisar antes de protocolar",
  incompleto: "Incompleto pelo playbook",
  risco_alto: "Risco alto — itens obrigatórios ausentes",
};
